...
<script type="text/javascript">
        function pegadados(){
            var palavraChave = document.formCid.palavraChave.value;
            var ajax = new AJAX();
            ajax.Updater("../modulos/cid/biblioteca/cidLst.php?palavraChave="+palavraChave,"divExibir", "get", "carregando os dados...");
        }
</script>
...
<div align="center">
    ...
    <h1>Cid</h1>
        <a href="?area=<?php echo base64_encode("../modulos/cid/backEnd/cidFrm.php")?>"><img src="../design/util/novo.png" border="0" /></a>
        <form name="formCid" id="formCid" method="post">
            <p>
            <b>Palavra-Chave</b>
