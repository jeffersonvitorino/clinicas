<section id="historia">
    ...
    <div id="historia_conteudo">
        <article>
            <h3>Nossa História</h3>
            <img src="design/layout/frontEnd/fotohistoria.jpg" width="455" height="200">
   ...
   <div id="galeria_historia">
        <article>
            <h3>Galeria</h3>
            <ul>
             <a href=""><li><img src="design/layout/frontEnd/fotogaleria.jpg" width="140" height="140"></li></a>
             <a href=""><li><img src="design/layout/frontEnd/fotogaleria.jpg" width="140" height="140"></li></a>
             <a href=""><li><img src="design/layout/frontEnd/fotogaleria.jpg" width="140" height="140"></li></a>
             <a href=""><li><img src="design/layout/frontEnd/fotogaleria.jpg" width="140" height="140"></li></a>
             <a href=""><li><img src="design/layout/frontEnd/fotogaleria.jpg" width="140" height="140"></li></a>
